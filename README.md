...
**NOTICE:** _This code is a conversion of the [Instana Robot-Shop](https://github.com/instana/robot-shop) microservice application to Knative serverless service. The serverless version of the Helm chart is under `/K8s/helm-less`._
